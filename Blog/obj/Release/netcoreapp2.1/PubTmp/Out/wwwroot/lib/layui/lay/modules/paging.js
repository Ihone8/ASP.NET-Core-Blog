...
layui.define(['layer', 'laypage', 'form', 'laytpl'], function (exports) {
    ...
    Paging.prototype.getPageIndex = function () {
        return this.config.params.pageIndex;
    }
                ...
                if (_config.checkbox) {
                    ...
                    form.on('checkbox(allselector)', function (data) {
                        ...
                        $(_config.elem).parent('table').children('tbody').children('tr').each(function () {
                            var $that = $(this);
                            var ck = $that.children('td').eq(0).find('input[type=checkbox]');
                            if (ck.length > 0) {
                                ck[0].checked = elem.checked;
                                if (elem.checked) {
                    ...
                    $(_config.elem).children('tr').each(function (e) {
                        ...
                        if (_config.singleSelected) {
                            ...
                            $that.on('click', function () {
                                if (!!$(this).children('td').eq(0).children('input[type=checkbox]')[0]) {
                                    //单选。
                            ...
                            $that.on('click', function () {//多选
                                var ck = $that.children('td').eq(0).children('input[type=checkbox]')[0].checked;
                                if (ck) {
                                    $that.children('td').eq(0).children('input[type=checkbox]')[0].checked = true;
                                    $that.css('background-color', '#F3F7F9');
